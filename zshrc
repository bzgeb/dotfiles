...
zstyle :compinstall filename '/home/bronson/.zshrc'
...
alias vimall="awk -F: '{print $1}'"
alias NES="/home/bronson/xwii/xwii profiles/NES_Pad.xwii"
...
setprompt () {
    ...
    case $TERM in
	xterm*)
	    PR_TITLEBAR=$'%{\e]0;%(!.-=*[ROOT]*=- | .)%n@%m:%~ | ${COLUMNS}x${LINES} | 
%y\a%}'
	    ;;
	screen)
